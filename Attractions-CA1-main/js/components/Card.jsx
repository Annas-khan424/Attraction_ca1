            ...
            >
               {!map ? (
                  ...
                  <iframe
                     ...
                     allowFullScreen
                     src={`https://www.google.com/maps/embed/v1/place?q=${attraction.name.replaceAll(' ', '+')}+${attraction.address.county}&key=AIzaSyCQRTMuRO4K1AyH9fFr6zH7Kd2qSwz3Wuk&libraries`}
                  ></iframe>
               )}
            </div>
